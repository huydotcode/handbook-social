...
const badgeVariants = cva(
    'inline-flex items-center rounded-full border px-2.5 py-0.5 text-sm transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2',
    {
        variants: {
            variant: {
                default:
                    'border-transparent bg-primary-1 hover:bg-primary-1/80',
                secondary:
                    'border-transparent bg-secondary-2 hover:bg-secondary-1/80 dark:bg-dark-secondary-2',
                destructive:
                    'border-transparent bg-destructive hover:bg-destructive/80',
                success: 'border-transparent bg-green-500 hover:bg-green-600',
                outline: '',
            },
        },
        defaultVariants: {
